...
class Record:
    ...
    # adding sender as string
    sender: str

    # adding receiver as string
    receiver: str

    # adding amount as float
    amount: float
...
if st.button("Add Block"):
    ...
    new_block = Block(
        ...
        # below line is no longer needed!
        # data=input_data,
        creator_id=42,
        prev_hash=prev_block_hash,
        # adding record w/ sender, receiver, and amount from above Step 3
        record = Record(sender_value, receiver_value, input_amount)
    )
